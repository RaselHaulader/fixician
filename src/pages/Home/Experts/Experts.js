          ...
          <Row>
            <Col xs={6} md={4}>
              ...
              <Card.Body className="bg-light">
                <Card.Title className="text-center mt-3 fs-4 fw-bold">
                  Md Rasel Haulader
                </Card.Title>
                <Card.Text className="text-center">Chairman</Card.Text>
              </Card.Body>
            </Col>
            <Col xs={6} md={4}>
              ...
              <Card.Body className="bg-light">
                ...
                <Card.Text className="text-center">Managing Director</Card.Text>
              </Card.Body>
            </Col>
            <Col xs={6} md={4}>
